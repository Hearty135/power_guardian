...
<nav class="visible-sm visible-xs mobile-menu-container mobile-nav">
    <div class="menu-mobile-nav navbar-toggle">
        <span class="icon-bar"><i class="fa fa-bolt" aria-hidden="true"></i></span>
    </div>
    <div id="cssmenu" class="animated">
        <div class="uni-icons-close"><i class="fa fa-bolt" aria-hidden="true"></i></div>
            ...
            <div class="copyright-area">
                <div class="container">
                    <div class="copyright-content">
                        <div class="row">
                            <div class="col-sm-6">
                                <p class="copyright-text"> <a href="#">POWERGUARDIAN+</a></p>
                            </div>
                            <div class="col-sm-6">
                               <p class="copyright-text"> <a href="#">By GROUP 3</a></p>
                            </div>
                        </div>
                    </div>
                </div>
